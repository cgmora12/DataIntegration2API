...
exports.getCOVIDminus19_Daily_Counts_of_Cases__Hospitalizations__and_DeathscsvCOVIDminus19_Hospital_Capacity_MetricscsvCOVIDminus19_Daily_Cases_and_Deathscsvcsv = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getcase_count_cases_total = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getdate_of_interest_date = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
